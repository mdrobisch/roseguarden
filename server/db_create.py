...
db.session.add(Door(id = 1, name = 'Local door', address = 'http://localhost', keyMask = 0x03, local = 0x01 ))
db.session.add(Door(id = 2, name = 'Outer door', address = 'http://192.168.0.59', keyMask = 0x03, local = 0x00 ))
db.session.add(Door(id = 3, name = 'Inner door', address = 'http://10.43.125.7', keyMask = 0x03, local = 0x00 ))
